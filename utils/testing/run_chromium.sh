...
$CHROMIUM_SRC/out/Default/chrome --use-fake-device-for-media-stream --use-file-for-fake-video-capture=$CHROMIUM_SRC/KristenAndSara_1280x720_60.y4m --enable-logging=stderr --log_level=0 --v=3 --force-fieldtrials=WebRTC-Debugging-RtpDump/Enabled  $2 > $1/log.txt 2>&1
