...
run_experiment () {
    mkdir $2
    bash ~/Code/tobias-master-thesis-webrtc/utils/testing/run_test.sh $CAPACITY_MBPS $RTT $QUEUE_PKTS $TEST_LEN $2 'rtp1start=10000\&rtp1end=120000\&sctp1start=0\&sctp1end=120000' "infinity,equal,$1"
