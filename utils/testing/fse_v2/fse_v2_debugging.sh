...
#bash ~/Code/tobias-master-thesis-webrtc/utils/testing/run_test.sh 2 50 10 40 $out_dir 'rtp1start=0\&rtp2start=10000' 'none'

#bash ~/Code/tobias-master-thesis-webrtc/utils/testing/run_test.sh 2 50 10 40 $out_dir 'rtp1start=0\&sctp1start=10000' 'FseV2,infinity,equal,CoupleDcSctp'
#bash ~/Code/tobias-master-thesis-webrtc/utils/testing/run_test.sh 2 50 10 40 $out_dir 'rtp1start=0\&sctp1start=10000' 'FseV2,infinity,equal'
...
#bash ~/Code/tobias-master-thesis-webrtc/utils/testing/run_test.sh 2 100 20 40 $out_dir 'rtp1start=0\&sctp1start=10000' 'FseV2,infinity,equal'
...
#bash ~/Code/tobias-master-thesis-webrtc/utils/testing/run_test.sh 3 50 15 50 $out_dir 'rtp1start=0\&sctp1start=10000' 'FseV2,infinity,equal,CoupleDcSctp'
