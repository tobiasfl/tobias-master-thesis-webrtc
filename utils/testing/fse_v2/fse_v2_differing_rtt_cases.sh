...
# SCTP starting first
#bash ~/Code/tobias-master-thesis-webrtc/utils/testing/run_test.sh 3 10 4 50 $out_dir 'sctp1start=0\&rtp1start=10000\&sctp1end=75000' 'FseV2,infinity,equal'
#bash ~/Code/tobias-master-thesis-webrtc/utils/testing/run_test.sh 3 10 4 50 $out_dir 'sctp1start=0\&rtp1start=10000\&rtp2start=20000\&rtp1end=65000\&rtp2end=75000' 'FseV2,infinity,equal'
...
# SCTP starting first
#bash ~/Code/tobias-master-thesis-webrtc/utils/testing/run_test.sh 3 25 9 50 $out_dir 'sctp1start=0\&rtp1start=10000\&sctp1end=75000' 'FseV2,infinity,equal'
#bash ~/Code/tobias-master-thesis-webrtc/utils/testing/run_test.sh 3 25 9 50 $out_dir 'sctp1start=0\&rtp1start=10000\&rtp2start=20000\&rtp1end=65000\&rtp2end=75000' 'FseV2,infinity,equal'
...
# SCTP starting first
#bash ~/Code/tobias-master-thesis-webrtc/utils/testing/run_test.sh 3 50 15 50 $out_dir 'sctp1start=0\&rtp1start=10000\&sctp1end=75000' 'FseV2,infinity,equal'
#bash ~/Code/tobias-master-thesis-webrtc/utils/testing/run_test.sh 3 50 15 50 $out_dir 'sctp1start=0\&rtp1start=10000\&rtp2start=20000\&rtp1end=65000\&rtp2end=75000' 'FseV2,infinity,equal'
