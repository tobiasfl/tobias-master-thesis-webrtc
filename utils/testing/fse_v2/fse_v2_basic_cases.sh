...
bash ~/Code/tobias-master-thesis-webrtc/utils/testing/run_test.sh 3 50 15 35 $out_dir 'rtp1start=0\&rtp1end=35000\&sctp1start=5000' 'FseV2,infinity,equal'
bash ~/Code/tobias-master-thesis-webrtc/utils/testing/run_test.sh 3 50 15 35 $out_dir 'rtp1start=0\&rtp1end=35000\&rtp2start=5000\&sctp1start=10000' 'FseV2,infinity,equal'
