...
bash ~/Code/tobias-master-thesis-webrtc/utils/testing/run_test.sh 3 50 15 85 $out_dir 'rtp1start=0\&sctp1start=5000' 'FseV2,infinity,equal'
bash ~/Code/tobias-master-thesis-webrtc/utils/testing/run_test.sh 3 50 15 85 $out_dir 'rtp1start=0\&rtp2start=5000\&sctp1start=10000' 'FseV2,infinity,equal'

# SCTP starting first
bash ~/Code/tobias-master-thesis-webrtc/utils/testing/run_test.sh 3 50 15 85 $out_dir 'sctp1start=0\&rtp1start=5000' 'FseV2,infinity,equal'
bash ~/Code/tobias-master-thesis-webrtc/utils/testing/run_test.sh 3 50 15 85 $out_dir 'sctp1start=0\&rtp1start=5000\&rtp2start=10000' 'FseV2,infinity,equal'
